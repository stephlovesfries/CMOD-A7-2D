...
## uncomment to allow combinational logic loops
...
set_property -dict {PACKAGE_PIN W3 IOSTANDARD LVCMOS33} [get_ports tilt]
set_property -dict {PACKAGE_PIN N1 IOSTANDARD LVCMOS33} [get_ports btnD]
set_property -dict {PACKAGE_PIN J3 IOSTANDARD LVCMOS33} [get_ports btnU]
set_property -dict {PACKAGE_PIN C15 IOSTANDARD LVCMOS33} [get_ports onpin]

##7 Segment Display
## D1-A-F-D2-D3-B
set_property -dict { PACKAGE_PIN W6   IOSTANDARD LVCMOS33 } [get_ports {an[0]}]
set_property -dict { PACKAGE_PIN U3   IOSTANDARD LVCMOS33 } [get_ports {seg[0]}]
set_property -dict { PACKAGE_PIN U7   IOSTANDARD LVCMOS33 } [get_ports {seg[5]}]
set_property -dict { PACKAGE_PIN W7   IOSTANDARD LVCMOS33 } [get_ports {an[1]}]
set_property -dict { PACKAGE_PIN U8   IOSTANDARD LVCMOS33 } [get_ports {an[2]}]
set_property -dict { PACKAGE_PIN V8   IOSTANDARD LVCMOS33 } [get_ports {seg[1]}]
##E-D-DP-C-G-D4
set_property -dict { PACKAGE_PIN M1   IOSTANDARD LVCMOS33 } [get_ports {seg[4]}]
set_property -dict { PACKAGE_PIN U5   IOSTANDARD LVCMOS33 } [get_ports {seg[3]}]
set_property -dict { PACKAGE_PIN W4   IOSTANDARD LVCMOS33 } [get_ports dp]
set_property -dict { PACKAGE_PIN V5   IOSTANDARD LVCMOS33 } [get_ports {seg[2]}]
set_property -dict { PACKAGE_PIN U4   IOSTANDARD LVCMOS33 } [get_ports {seg[6]}]
set_property -dict { PACKAGE_PIN V4   IOSTANDARD LVCMOS33 } [get_ports {an[3]}]
